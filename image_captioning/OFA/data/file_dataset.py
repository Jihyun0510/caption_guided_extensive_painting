...
class FileDataset:
    ...
    def __getitem__(self, index):
        ...
        #         # print("@@@@@@@@@@@@@@@@@@@@col_id",col_id)
                print(column_l)
                # print("@@@@@@@@@@@@@@@@@@@@col_l", len(column_l))
        #         print("whyrano")
        ##################
        column_l = [dtype(column_l[col_id]) for col_id, dtype in zip(self.selected_col_ids, self.dtypes)]
        # print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@", len(column_l))
        # print(column_l[1][2:-1])
        # xxxxx = column_l[1].split(",")
        # print(len(xxxxx))
        # column_l[1] = column_l[1].replace("'b","")
        # column_l[1] = column_l[1].replace("'","")
        # column_l[2] = column_l[2].replace(',', '&&')
        # print("@@@@@@@@@@@@@@@@@@@@@@@\n",column_l)
