...
# log_dir=./stage2_logs_fromcheckpoint
log_dir=./stage2_logs_final
save_dir=/database/jhkim/final_final_random_checkpoints/
# save_dir=./stage2_resize_checkpoints
mkdir -p $log_dir $save_dirg

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=../../dataset/caption_data
# data_dir= /home/wgus5950/OFA2/dataset/caption_data/
data=${data_dir}/caption_train_final.tsv,${data_dir}/caption_val_final.tsv
# data=${data_dir}/caption_train.tsv,${data_dir}/caption_val.tsv
# restore_file=../../checkpoints/caption_large_best_clean.pt
restore_file=/database/jhkim/caption_large_best_clean.pt
selected_cols=1,4,2
task=caption
arch=ofa_large
