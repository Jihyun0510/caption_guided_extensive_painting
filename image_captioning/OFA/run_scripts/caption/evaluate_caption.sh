...
data=../../dataset/caption_data/landmark_half_128.tsv
# data=/home/wgus5950/OFA/dataset/caption_data/caption_test_random.tsv

path=/database/jhkim/final_random_checkpoints/5e-6_5/checkpoint_1_4000.pt
# path=/database/jhkim/caption_large_best_clean.pt
